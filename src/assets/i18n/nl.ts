  ...
  components: {
    ...
    'privacy-policy': {
      ...
      'privacy-policy-blocks': {
        ...
        contact: {
          title: 'Contact',
          text: '<p>Heb je vragen of opmerkingen over de manier waarop je persoonlijke gegevens worden gebruikt via een van de hierboven vermelde manieren? Neem contact op via <a href="mailto:marketing@claes-distribution.be">marketing@claes-distribution.be</a></p><p>Je kan je met een klacht ook rechtstreeks wenden tot de Gegevensbeschermingsautoriteit (de vroegere ‘Privacycommissie’) via <a href="https://www.gegevensbeschermingsautoriteit.be/contact" target="_blank">www.gegevensbeschermingsautoriteit.be/contact</a></p>'
        }
      }
    }
  },
