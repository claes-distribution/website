...
export const fr = {
  components: {
    ...
    home: {
      ...
      'home-products-order': {
        'block-products': {
          title: 'Keuze uit meer dan 14.000 producten',
          text: 'Op zoek naar een specifiek artikel om vlees of andere voeding te bereiden, verwerken, presenteren of verpakken? Je vindt het ongetwijfeld in ons gevarieerde assortiment dat nog dagelijks uitbreidt. Wij werken uitsluitend samen met vooraanstaande leveranciers en selecteren elk product met de allergrootste zorg. Zo slagen we erin om onze klanten kwaliteit met grote K te bieden, exact zoals ze van ons gewend zijn.',
          button: 'Duik in ons assortiment'
        },
        'block-order': {
          title: 'Een bestelling plaatsen? Jij bepaalt hoe!',
          text: 'Of je nu een nieuwe klant bent of al jaren samenwerkt met Claes Distribution: we maken het je graag gemakkelijk en staan steeds paraat om onze kennis en kunde met je te delen. Zo ben je zeker dat je jouw aankopen doet in alle vertrouwen. Wil je een order doorgeven? Dat kan op 6 verschillende manieren, dus kies gerust wat voor jou het beste uitkomt.',
          button: 'Zo kan je ons bereiken'
        }
      },
      'home-benefits': {
        'block-1': {
          title: 'Expertise',
          text: 'Wij kennen ons vak als geen ander: al meer dan 50 jaar is Claes Distribution actief in de vleesverwerkende sector en voedingsindustrie. Dat maakt van ons een betrouwbare partner die actief met je meedenkt en deskundig advies geeft. Vanuit onze klantgerichte instelling stellen we enkel producten voor die volledig aansluiten bij je huidige én toekomstige behoeftes.'
        },
        'block-2': {
          title: 'Kwaliteit',
        ...
        'block-3': {
          title: 'Flexibiliteit',
          text: 'Een vlotte service met korte levertermijnen: dat is wat jij van ons verwacht. Om snel in te spelen op elke vraag beschikt Claes Distribution over een toegewijd team van klantgerichte medewerkers en een eigen vloot van (gekoelde) vrachtwagens. Dagelijks voeren wij leveringen uit bij klanten in België, Nederland, Luxemburg en Frankrijk. Altijd met de glimlach, stipt en correct.'
        },
        'block-4': {
    ...
    order: {
      'order-text': {
        title: 'Zo kan je bestellen',
        text: 'Wil je een order plaatsen? Er zijn heel wat manieren waarop je een bestelling kan doorgeven, maar 1 ding is zeker: jouw gemak staat voorop. Kies zelf waar, wanneer en hoe het voor jou het beste past en wij gaan meteen aan de slag. Reken op degelijk advies, duidelijke informatie, vlotte service, veilige verwerking én snelle levering in alle vertrouwen. Daar worden wij spontaan blij van en jij wellicht ook!'
      },
      'order-methods': {
        'order-method-shop': {
    ...
    inspire: {
      'inspire-text': {
        title: 'Claes Distribution denkt met je mee',
        text: 'Jouw vak is ook ons vak. Om bij te blijven en uit te blinken, houden we je op de hoogte van al wat er leeft in de wereld van slagerij en voedingsindustrie. Nieuwigheden, trends, tips, recepten … we delen ze graag met jou. Zo haal jij het meeste uit je assortiment én krijgt je verkoop een boost. Bovendien laten we je maandelijks meegenieten van interessante kortingen en promoties!'
      },
    ...
    'cookie-popup': {
      ...
      text: ' gebruikt cookies om je een betere en meer gepersonaliseerde gebruikservaring te bieden. Door verder te surfen, ga je akkoord met het gebruik van deze cookies.',
      button: 'Ik ga akkoord!',
      link: 'Lees onze privacy policy'
    },
    'privacy-policy': {
      'privacy-policy-title': {
        title: 'Déclaration de confidentialité site web',
        text: 'Bienvenue sur le site web de Claes Distribution. Vous trouverez ci-dessous notre politique de confidentialité pour vous informer des types de données personnelles qui sont recueillies et comment nous les utilisons. Cette déclaration de confidentialité peut être mise à jour. Nous recommandons de consulter régulièrement cette déclaration de confidentialité afin de vérifier s’il y a eu des modifications. En utilisant ce site web, vous acceptez la présente déclaration de confidentialité et notre utilisation des cookies telle que décrite ci-dessous. Si vous n’acceptez pas ces conditions, veuillez ne pas utiliser ce site web.'
      },
      'privacy-policy-blocks': {
        'intellectual-rights': {
          title: 'Droits de propriété intellectuelle',
          text: '<p>Le contenu de ce site web, y compris les marques, les logos, les dessins, les données, les noms de produits ou commerciaux, les textes, les images, etc. sont protégés par des droits intellectuels et appartiennent à Claes Distribution ou à des tiers habilités.</p>'
        },
        liability: {
          title: 'Limitation de responsabilité',
          text: '<p>Les informations sur le site web sont de nature générale. Les informations ne sont pas adaptées à des circonstances personnelles ou spécifiques, et ne peuvent donc pas être considérées comme des conseils personnels, professionnels ou juridiques à l’utilisateur.</p><p>Claes Distribution fait de grands efforts pour que les informations fournies soient complètes, exactes, précises et mises à jour. Malgré ces efforts, des inexactitudes peuvent apparaître dans les informations fournies. Si les informations fournies contiennent des inexactitudes ou si certaines informations sur ou via le site web ne sont pas disponibles, Claes Distribution fera tout son possible pour le rectifier dans les meilleurs délais.</p><p>Toutefois, Claes Distribution ne peut pas être tenu responsable de dommages directs ou indirects résultant de l’utilisation des informations contenues dans ce site web. Si vous découvrez des inexactitudes dans les informations mises à disposition sur le site web, vous pouvez contacter l’administrateur du site web.</p><p>Le contenu du site web (y compris les liens) peut être modifié, changé ou complété à tout moment sans préavis ou notification préalable. Claes Distribution ne donne aucune garantie pour le bon fonctionnement du site web et ne peut en aucun cas être tenu responsable d’un dysfonctionnement ou d’une (in)disponibilité temporaire du site web ou de toute forme de dommage, direct ou indirect, qui résulterait de l’accès au ou de l’utilisation du site web.</p><p>Claes Distribution ne peut en aucun cas être tenu responsable envers quiconque, directement ou indirectement, de façon particulière ou autre, des dommages dus à l’utilisation de ce site web ou de tout autre, notamment en raison des liens ou des hyperliens, y compris et sans limitation, toutes pertes, toutes interruptions de travail, tous dommages aux programmes ou à d’autres données sur le système informatique, le matériel, le logiciel ou d’autre de l’utilisateur.</p><p>Le site web peut contenir des hyperliens vers des sites web ou des pages de tiers, ou y faire indirectement référence. Le placement de liens vers ces sites ou ces pages n’implique en aucune façon une approbation implicite de leur contenu.</p><p>Claes Distribution déclare expressément n’avoir aucun contrôle sur le contenu ou les autres caractéristiques de ces sites web et ne peut en aucun cas être tenue responsable de leur contenu ou de leurs caractéristiques ou de toute autre forme de dommage résultant de leur utilisation.</p>'
        },
        'applicable-law': {
          title: 'Droit applicable',
          text: '<p>Le droit belge s’applique à ce site web et au disclaimer. Tout litige au titre du ou relatif au présent disclaimer sera exclusivement soumis à la juridiction compétente.</p>'
        },
        'data-collection': {
          title: 'Collecte des données',
          text: '<p>Pour le traitement des données personnelles dans le cadre des activités mentionnées dans la présente déclaration, Claes Distribution se considère comme le responsable du traitement au sens du Règlement Général sur la Protection des Données.</p><p>En fonction de la façon dont vous utilisez notre site web, nous pouvons recueillir et stocker différents types de d’informations vous concernant. Nous recueillons des données personnelles via le site web. Par exemple, votre nom et votre adresse e-mail, que vous nous fournissez pour certains produits et services.</p><p>Nous recueillons également des informations sur le navigateur de votre ordinateur, y compris l’adresse IP et l’emplacement d’une personne, le type de navigateur, le système d’exploitation et les pages web que vous visitez. Cela nous permet d’afficher et de concevoir des contenus et des services pertinents pour cet appareil.</p>'
        },
        security: {
          title: 'Protection',
          text: '<p>Nous nous efforçons de conserver vos données en toute sécurité dans le respect de votre vie privée. Nous avons donc mis en place des mesures de sécurité techniques et organisationnelles pour éviter la perte de vos données ou l\'accès non autorisé à vos données.</p>'
        },
        storage: {
          title: 'Stockage des données',
          text: '<p>Nous ne conservons vos données pas plus longtemps que nécessaire. Nous ne les conservons que dans la mesure nécessaire ou pertinente.</p>'
        },
        sharing: {
        ...
        'cookie-statment': {
          ...
          text: '<p>Ce site web utilise des cookies. Un cookie est une petite quantité de données générées par un site web et stockées par votre navigateur web. Un cookie stocke des données vous concernant et ressemble au fichier de préférences créé par les applications logicielles.</p><p>Les cookies ont différentes fonctions. Certains cookies sont essentiels au bon fonctionnement de notre site web et de nos services. Certains cookies sont permanents, ce qui signifie qu’ils restent sur votre appareil après que vous avez quitté le site web. Certains cookies sont des cookies de session, ce qui signifie qu’ils sont supprimés dès que vous fermez votre navigateur web. Les paramètres de votre navigateur web vous permettent de gérer vos préférences en matière de cookies, mais veuillez noter que le fonctionnement du site web peut être affecté par la modification des préférences en matière de cookies (le site web peut ne pas être disponible ou peut fonctionner moins efficacement). En utilisant notre site web, vous acceptez que nous utilisions des cookies.</p>'
        },
        'google-analytics': {
          title: 'Utilisation de Google Analytics',
          text: '<p>Ce site web utilise Google Analytics, un service d’analyse web fourni par Google Inc. (“Google”). Google Analytics utilise des “cookies” (des petits fichiers texte stockés sur votre ordinateur) pour aider le site web à analyser l’utilisation du site web par ses utilisateurs. Nous utilisons ces informations pour améliorer le fonctionnement et la convivialité du site web et pour identifier le trafic sur le site web.</p><p>Les informations générées sur votre utilisation du site web (y compris votre adresse IP) seront transmises à et stockées par Google sur des serveurs situés aux États-Unis. Google utilisera ces informations afin de retenir votre utilisation du site web, afin de compiler des rapports sur l’activité sur le site web pour les exploitants du site web et afin de fournir d’autres services relatifs à l’activité du site web et à l’utilisation d’Internet. Google peut également transférer ces informations à des tiers lorsque la loi l’exige ou lorsque ces tiers traitent les informations pour le compte de Google. Google ne va jamais associer votre adresse IP à d’autres données dont Google dispose. Vous pouvez refuser l’utilisation de cookies en sélectionnant les paramètres appropriés dans votre navigateur. Veuillez toutefois noter que, dans ce cas, vous ne pourrez peut-être pas utiliser toutes les fonctionnalités de ce site web. En utilisant ce site web, vous consentez au traitement des données vous concernant par Google de la manière et aux fins décrites ci-dessus.</p>'
        },
        contact: {
          title: 'Contact',
  ...
  pages: {
    ...
    'product-categories': {
      ...
      koopjes: {
        ...
        metaDescription: 'In ons uitverkoophoekje vind je o.a. producten die het assortiment verlaten of voedingsmiddelen die dichtbij de THT-datum komen. Doe snel je voordeel!'
      }
    },
    order: {
