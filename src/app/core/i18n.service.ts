...
import { nlBE } from '../../assets/i18n/nl-BE';
import { frBE } from '../../assets/i18n/fr-BE';
...
export class I18nService {
  ...
  constructor(private translateService: TranslateService) {
    ...
    translateService.setTranslation('nl-BE', nlBE);
    translateService.setTranslation('fr-BE', frBE);
  }
